    ...
    <div class="row px-1" >
        <div class="col-md-10">
            ...
            <div class="row" >
             ...
             <!-- <div class="col-md-4"> //it will paste to commom_fn.php
                //card start
                 <div class='card'>
                  <img src='./img/dell1.jpg' class='card-img-top' alt='$product_title'>
                  <div class='card-body'>
            ...
            <!-- <div class="col-md-8"> //it will paste to commom_fn.php
                // related images 
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="col-md-6">
                        <img src='./img/dell2.jpg' class='card-img-top' alt='$product_title'>
                        </div>
                        <div class="col-md-6">
                        <img src='./img/dell3.jpg' class='card-img-top' alt='$product_title'>
                        </div>
            ...
            //getproducts();//limit product will be display and i don't want for product_details
            //get_all_products();
            get_unique_products();
            get_unique_brand();
            veiw_details();

            cart(); //call from commom_function
