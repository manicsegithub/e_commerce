...
<body>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <!-- php code for when the user is login user account will display replace by register start -->
                        <?php
                        ...
                        ?>
                        <!-- php code for when the user is login user account will display replace by register end -->
    ...
    <!-- 3rd Child start -->
    <div class="bg-light">
        <h3 class="text-center">Yuva Computer's</h3>
